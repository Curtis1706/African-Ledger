...
const MOCK_CLIENT_DETAIL: Client = {
  id: 1,
  name: "Moussa Diop",
  email: "moussa@diop.com",
  ...
  transactions: [
    { id: 101, date: "2026-04-02", description: "Paiement Facture FA-2026-001", amount: 150000, type: "revenue", category: "Vente" },
    { id: 102, date: "2026-03-15", description: "Acompte Projet Sahel", amount: 1100000, type: "revenue", category: "Services" },
  ]
};
