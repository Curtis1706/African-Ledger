...
import { useListTransactions, useCreateTransaction, useDeleteTransaction } from "@workspace/api-client-react";
import type { CreateTransactionBodyType, ListTransactionsType } from "@workspace/api-client-react";
import { formatCurrency, formatDate } from "@/lib/format";
import { Card, CardContent } from "@/components/ui/card";
import { Input } from "@/components/ui/input";
import { Button } from "@/components/ui/button";
import { Search, Plus, ArrowUpRight, ArrowDownRight, Trash2, Filter } from "lucide-react";
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center bg-card p-4 rounded-xl border shadow-sm">
        ...
        <div className="flex gap-2 w-full sm:w-auto ml-auto">
          <Select value={typeFilter || "all"} onValueChange={(v) => setTypeFilter(v === "all" ? undefined : v as ListTransactionsType)}>
